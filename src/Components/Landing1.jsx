...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main>
        {/* Add Product Button - Only show when user is logged in and not already on addProduct view */}
        {user && currentView !== 'addProduct' && (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <button
              onClick={() => setCurrentView('addProduct')}
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 flex items-center gap-2"
            >
